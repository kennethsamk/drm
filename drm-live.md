...
and make a  note of the below paramter
...
```
MediaPackageSPEKERoleArn ( Replace with your AWS AccountID and InstanceID: 
```
arn:aws:iam::{AWS_ACCOUNT}:role/speke-reference-MediaPackageInvokeSPEKERole-{INSTANCE_ID}
```
